        ...
        {
            {
                if (tenkhach.Text == "")
                    ...
                    try
                    {
                        ...
                        string sql2 = "INSERT INTO PHONGTHUE(MAKH,MADK,SOPHONG,NGAYDEN,NGAYDI,NGAYDK) VALUES('" + bunifuTextBox2.Text.Trim() + "','" + bunifuTextBox2.Text + "','" + comboBox3.Text + "'," + bunifuDatepicker2.Value.ToString("yyyy/MM/dd") + "," + bunifuDatepicker3.Value.Day + "/" + bunifuDatepicker3.Value.Month + "/" + bunifuDatepicker3.Value.Year + "," + DateTime.Now.Day + "/" + DateTime.Now.Month + "/" + DateTime.Now.Year + ")";
