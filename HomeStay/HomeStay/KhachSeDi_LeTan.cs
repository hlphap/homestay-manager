    ...
    public partial class KhachSeDi_LeTan : UserControl
    {
        ...
        private void KhachSeDi_LeTan_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql4 = "SELECT PHONGTHUE.SOPHONG as 'Số phòng', MADK as 'Mã đặt phòng', HOTENKH as 'Họ tên', LOAIPHONG as 'Loại phòng', NGAYDEN as 'Ngày đến', NGAYDI as 'Ngày đi' FROM KHACHHANG, PHONGTHUE, PHONG WHERE PHONG.SOPHONG = PHONGTHUE.SOPHONG AND KHACHHANG.MAKH = PHONGTHUE.MAKH AND  '" + DateTime.Now.ToString("yyyy / MM / dd") + " 00:00:00.000' = NGAYDI";
